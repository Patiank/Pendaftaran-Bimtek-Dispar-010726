            ...
            <div className="lg:col-span-3 space-y-4">
              <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-1.5">
                ...
                >
                  ...
                  <span>{settings?.isCertificateFeatureDisabled ? "Kartu Peserta" : "Kartu Peserta & Sertifikat"}</span>
                  {recentRegistration && (
              ...
              {activeTab === "admin" && isAdminAuthorized && (
                <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm space-y-1.5 animate-fade-in">
                  ...
                  <button
                    ...
                    className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-xs sm:text-sm font-bold text-red-600 hover:bg-red-50 hover:text-red-700 transition-all font-semibold border border-transparent hover:border-red-100 text-left"
                  >
                  ...
                  <div className="space-y-10 py-4 max-w-6xl mx-auto">
                    ...
                    <div className={`grid grid-cols-1 ${(settings?.durationDays || 3) > 1 ? "md:grid-cols-3" : "md:grid-cols-2"} gap-6 max-w-5xl mx-auto`}>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="space-y-1.5">
                            <h3 className="text-base sm:text-lg font-black text-slate-900 group-hover:text-indigo-700 transition-colors">
                              {settings?.isCertificateFeatureDisabled ? "Kartu Peserta" : "Kartu Peserta dan Sertifikat"}
                            </h3>
                            <p className="text-xs text-slate-500 leading-relaxed">
                      ...
                      {(settings?.durationDays || 3) > 1 && (
                        ...
                        >
                          <div className="space-y-4">
                            <div className="w-14 h-14 bg-sky-50 rounded-2xl flex items-center justify-center mx-auto text-sky-600 group-hover:scale-110 transition-transform duration-300">
                              <CheckSquare className="w-7 h-7" />
                            </div>
                            <div className="space-y-1.5">
                              <h3 className="text-base sm:text-lg font-black text-slate-900 group-hover:text-sky-700 transition-colors">
                                Absensi Harian Bimtek
                              </h3>
                              <p className="text-xs text-slate-500 leading-relaxed">
                                Isi paraf kehadiran harian Anda (Hari 2 dst.) dengan cepat secara digital. Catatan absensi langsung tersimpan.
                              </p>
                            </div>
                          </div>
                          <div className="mt-8">
                            <span className="inline-block px-5 py-2.5 bg-sky-600 hover:bg-sky-700 text-white text-xs font-bold rounded-2xl group-hover:shadow-lg shadow-sky-600/10 transition-all">
                              Isi Absensi Harian &rsaquo;
                            </span>
                          </div>
                        </div>
                      )}
